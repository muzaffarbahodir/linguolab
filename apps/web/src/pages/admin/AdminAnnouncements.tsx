                  ...
                  {STYLES.map((s) => (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${draft.style === s ? '#6366f1' : 'var(--hairline)'}`,
                      }}
                    >
                      {styleLabel(s)}
                    </button>
                  ...
                  {POSITIONS.map((p) => (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${draft.position === p ? '#6366f1' : 'var(--hairline)'}`,
                      }}
                    >
                  ...
                  {draft.id && (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${draft.duration === -1 ? '#6366f1' : 'var(--hairline)'}`,
                      }}
                    >
                  ...
                  {DURATIONS.map((d) => (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${draft.duration === d.v ? '#6366f1' : 'var(--hairline)'}`,
                      }}
                    >
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          border: `2px solid ${on ? '#6366f1' : 'var(--hairline)'}`,
                        }}
                      >
                  ...
                  {RECURRENCES.map((r) => (
                    <button
                      ...
                      style={{
                        ...
                        border: `2px solid ${draft.recurrence === r ? '#6366f1' : 'var(--hairline)'}`,
                      }}
                    >
                    ...
                    {WEEKDAYS.map((d) => (
                      <button
                        ...
                        style={{
                          ...
                          border: `2px solid ${draft.recurrenceDay === d ? '#6366f1' : 'var(--hairline)'}`,
                        }}
                      >
              ...
              {!draft.id && (
                <label className="bg-surface flex items-center justify-between rounded-xl px-3 py-2.5">
                  ...
                  <input
                    ...
                    className="h-5 w-5 shrink-0 accent-[#6366f1]"
                  />
                </label>
              )}
